export default  function Brandimages (){
   ...
   <div><div className="lg:w-[1050px] w-[414px] flex-col flex  items-center  lg:ml-[195px] h-[175px] pt-[80px] pb-[50px] lg:flex-row justify-between gap:[60px] lg:gap-[30px]">
            ...
            <img src="/images/fa-brands-3.png" alt="brands" className="w-[102px] lg:mt-[1px] mt-[100px] h-[75px]" />
            <img src="/images/fa-brands-4.png" alt="brands" className="w-[103px] h-[42px] lg:mt-[1px] mt-[100px]" />
            <img src="/images/fa-brands-5.png" alt="brands" className="w-[103px] h-[62px] lg:mt-[1px] mt-[100px]" />
            <img src="/images/fa-brands-6.png" alt="brands" className="w-[76px] h-[72px] lg:mt-[1px] mt-[100px]" />
           </div>
            </div></div>)
}
